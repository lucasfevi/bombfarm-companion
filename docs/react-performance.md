...
**Every `memo(`/`useCallback(` hit in the shipped tree was inventoried and judged** — full detail was filed in the W8 memo-retirement ledger (private planning archive). Two `memo()` boundaries existed:
