...
export const en = {
  ...
  liveEarningsGoldRecentLabel: 'gold · last {minutes} min',
  liveEarningsGoldSessionLabel: 'gold · session',
  liveEarningsXpRecentLabel: 'xp · last {minutes} min',
  liveEarningsXpSessionLabel: 'xp · session',
