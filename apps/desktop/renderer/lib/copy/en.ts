...
export const en = {
  ...
  pvpStandingTier: 'tier {tier} · next tier at {next}',
  pvpStandingTierNoNext: 'tier {tier}',
  ...
  pvpStandingRankAge: 'as of {age}, at {points} points',
  pvpStandingRankUnknown: 'Open the ranking in the game once',
  pvpStandingUnknown: 'Not read yet',
  pvpStandingAge: 'as of {age}',
  pvpStandingEmpty: 'Nothing read yet — the game reports your standing when you open PVP or fight a duel.',
