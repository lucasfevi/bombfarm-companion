...
export const en = {
  ...
  accountHoldingsBag: 'Bag',
  accountHoldingsBagCoverage: '{priced} of {eligible} tradable items priced',
  accountHoldingsBagWithheld: 'Your bag has not been read yet',
  accountHoldingsBagLink: 'Open the bag',
