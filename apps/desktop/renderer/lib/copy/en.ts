...
export const en = {
  ...
  applyPanelIntro: 'What each step will do, before you press anything.',
  applyLedgerTotal: 'Total',
  applyLedgerReset: 'Reset points',
  applyLedgerForge: 'Forge — can run over',
  applyLedgerForgeNone: 'Forge — no estimate',
  applyLedgerEquip: 'Equip — no gold',
  applyLedgerWallet: '{before} → {after}',
  applyStepEquipTitle: 'Equip',
  applyStepEquipFacts: '{calls} calls · about {time} · no gold',
  applyStepForgeTitle: 'Forge',
  ...
  applyStepPointsFacts: '{heroes} heroes ({respecs} with a respec) · {calls} calls · about {time} · {gold}',
  ...
  applyPanelStale: 'The account moved since this plan — build it again to apply it',
  applyPanelOtherRunning: '{step} is running — the other steps wait',
  applyConfirmEquipTitle: 'Equip items?',
  applyConfirmEquipBody: 'This equips and unequips items your plan expects, at no gold cost.',
  applyConfirmEquip: 'Equip {count} items — no gold',
  ...
  applyConfirmPointsHeroRespec: '{hero} · level {level} · respec, then place {points} points · {gold}',
  applyConfirmPointsHeroPlace: '{hero} · level {level} · place {points} unspent points · free',
  applyConfirmPointsHeroSkip: '{hero} · skipped — {reason}',
  ...
  applyModalProgress: 'call {n} of {total} · {elapsed} elapsed · about {left} left',
  applyModalWaitingForge: 'Waiting for the forge piece in flight…',
  applyModalCallEquip: '{from} → {item} → {to}',
  applyModalCallEquipFromBag: 'bag → {item} → {to}',
  applyModalCallUnequip: '{item} → bag',
  applyModalCallRespec: '{hero} — respec, then {points} points',
  applyModalCallCommit: '{hero} — place {points} points',
  applyModalCooldown:
    'The game server asked us to slow down — resuming in {countdown}. Call {n} was not sent; nothing is half-done.',
  ...
  // skills* — the Skill Tree screen: the account's tree as the game lays it out, and what one
  // more level of each buyable node is worth to the farm. Arm, tier and node vocabulary prints
  // the game's own words. Buying stays in the game; nothing here is written back.
  skillsNavLabel: 'Skill Tree',
  ...
  skillsUnreadableTitle: 'Your skill tree has not been read yet',
  skillsArmHub: 'Hub',
  ...
  skillsPvpEmpty: 'The PVP squad is empty. Ranking waits for heroes in the standing slots rather than inventing a team.',
  skillsPricingUnavailable: 'The roster could not be priced, so no node has a figure yet. The tree still shows.',
  skillsPricedAtPhase: 'Priced on phase {phase}, the one your Farm tab is set to.',
  skillsPricedAtAccountPhase: 'Priced on phase {phase}, the one your account is farming now — pick a phase on the Farm tab to price elsewhere.',
