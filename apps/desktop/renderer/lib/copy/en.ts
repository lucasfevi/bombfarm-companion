...
export const en = {
  ...
  feedsNeverRead: 'Not read yet this session',
  feedsReadingNow: 'Reading now…',
  feedsOutOfDate: 'Out of date — this screen was computed from an older copy of the account',
  feedsEvery: 'Refreshes itself every {cycle} · next in {age}',
  feedsEveryDue: 'Refreshes itself every {cycle} · due now',
  feedsEveryUnread: 'Refreshes itself every {cycle}',
