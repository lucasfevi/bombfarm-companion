...
export const en = {
  ...
  pvpNavLabel: 'PVP',
  pvpStandingTitle: 'Your standing',
  pvpStandingTier: 'Tier',
  pvpStandingTierNote: 'The next tier starts at {next} points.',
  pvpStandingPoints: 'Points',
  pvpStandingPointsValue: '{points} / {next}',
  pvpStandingDuels: 'Duels left today',
  pvpStandingDuelsValue: '{left} of {max}',
  pvpStandingSlots: 'Squad slots',
  pvpStandingSlotsValue: '{slots} of {max}',
  pvpStandingRank: 'Leaderboard',
  pvpStandingRankValue: '#{position}',
  pvpStandingRankNote: 'Your place on the points board, read {age} at {points} points.',
  pvpStandingRankUnknown: 'Not read yet',
  pvpStandingUnknown: 'Not read yet',
  pvpStandingAge: 'as of {age}',
  pvpStandingEmpty: 'Nothing read yet — your standing is asked for when this tab opens, once the game is running.',
  pvpFilterOpponentLabel: 'Opponent',
  pvpFilterOpponentAll: 'All opponents',
  pvpFilterOpponentSearch: 'Type a name',
  pvpFilterOpponentNoMatch: 'No opponent by that name',
  pvpFilterResultLabel: 'Result',
  pvpFilterResultAll: 'All',
  pvpFilterEmpty: 'No duels match these filters.',
  pvpHeadToHeadTitle: 'Against {name}',
  ...
  pvpStandingMeterLabel: 'Tier {tier} to Tier {next}',
  pvpStandingEta: '{wins} to go at {step} a win',
  pvpStandingEtaWithDays: '{wins} to go at {step} a win, about {days} at today’s quota',
  pvpStandingEtaWins: '{wins} wins',
  pvpStandingEtaDays: '{days} days',
  pvpStandingTrendLabel: 'Points after each duel',
  pvpStandingTrendSummary: 'last {n}, win rate {pct}%, streak {streak}',
  pvpStandingTrendAria: 'Points after each of the last {n} duels',
  pvpStandingStreakWon: 'W{n}',
  pvpStandingStreakLost: 'L{n}',
  pvpStandingTrendEmpty: 'The points trend needs at least two duels.',
  pvpStandingLegendWon: 'won',
  pvpStandingLegendLost: 'lost',
  ...
  pvpRivalsRecordHint: 'Duels won, then duels lost, against this opponent.',
  pvpRivalsMarginHint: 'Your summed score over theirs, across every duel against this opponent.',
  pvpRivalsLastWon: 'won {age}',
  pvpRivalsLastLost: 'lost {age}',
  pvpSquadColumn: 'Your squad',
  pvpSquadHint: 'The heroes you fielded, in slot order. A slot with a question mark is a hero no longer on your roster.',
  pvpSquadUnknownHero: 'Hero not on the roster',
  pvpSquadUnknownMark: '?',
  pvpReplayTitle: 'Duel replay',
  pvpReplayNote: '{opponent}, film {id}, {frames} frames at {hz} Hz',
  pvpReplayClose: 'Close',
  pvpReplayLoading: 'Reading the film…',
  pvpReplayMissing: 'This film is not held.',
  pvpReplayLeadTaken: 'Lead taken',
  pvpReplayLeadTakenAt: '{s} s',
  pvpReplayLeadTakenNever: 'never',
  pvpReplayWidestLead: 'Widest lead',
  pvpReplayWidestLeadAt: 'at {s} s',
  pvpReplayRoomHp: 'Room HP left',
  pvpReplayBombs: 'Bombs',
  pvpReplayBombsValue: '{a} vs {d}',
  pvpReplayChartLabel: 'Damage by second: yours, theirs, and the room HP left',
  ...
  pvpPhaseCell: '{phase} (T{tier}, floor {floor})',
  pvpPhaseHint: 'The phase the duel was fought in, then your tier and the lowest phase that tier fights at.',
