...
export const en = {
  ...
  heroesBoardSortLabel: 'Sort by',
  heroesBoardSortRoll: 'Roll',
  heroesBoardSortPower: 'Power',
  heroesBoardSortLevel: 'Level',
  heroesBoardSortRarity: 'Rarity',
  heroesBoardSortRank: 'Grade',
  heroesBoardSortStars: 'Stars',
  heroesBoardSortAscending: 'Worst first',
  heroesBoardSortDescending: 'Best first',
  heroesBoardHideDisabled: 'In the rotation only',
  heroesBoardAbilityFilterLabel: 'Filter by ability',
  heroesBoardAbilityFilterOption: 'Only heroes with {ability}',
  heroesBoardAbilityFilterAbsent: 'No hero here has {ability}',
