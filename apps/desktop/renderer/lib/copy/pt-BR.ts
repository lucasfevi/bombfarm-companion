...
export const ptBR: Copy = {
  ...
  pvpStandingTier: 'faixa {tier} · próxima faixa em {next}',
  pvpStandingTierNoNext: 'faixa {tier}',
  ...
  pvpStandingRankAge: 'lido {age}, com {points} pontos',
  pvpStandingRankUnknown: 'Abra o ranking no jogo uma vez',
  pvpStandingUnknown: 'Ainda não lido',
  pvpStandingAge: 'lido {age}',
  pvpStandingEmpty: 'Nada lido ainda — o jogo informa sua posição quando você abre o PVP ou luta um duelo.',
  ...
  pvpTierFloor: 'faixa {tier}, piso {floor}',
  pvpPhaseHint: 'A fase em que o duelo foi lutado. O piso da faixa é a fase mais baixa em que a sua faixa luta.',
