...
export const ptBR: Copy = {
  ...
  // forge* — a tela da Forja: escolha uma peça, escolha um alvo, veja o que a subida rende e
  // quanto deve custar. Os níveis de forja chegam como valores (`{target}` é "+13"), nunca como
  // caracteres próprios.
  forgeNavLabel: 'Forja',
  forgeTitle: 'Forja',
  ...
  forgeMinForgeLabel: 'Forja mínima',
  forgeMinAny: 'Qualquer forja',
  forgeMinAndUp: '{level} ou mais',
  forgeMinOnly: 'só {level}',
  forgeHeroHint: 'Mostrando o que {hero} está usando',
  forgeBagFree: '{free} de {capacity} espaços livres na mochila',
  forgeTableCaption: 'Cada peça de equipamento da conta, ordenada pelo nível de forja',
  forgeColumnSlot: 'Espaço',
  forgeColumnForge: 'Forja',
  forgeColumnPower: 'Poder',
  forgeColumnBuys: '{step} rende',
  forgeBuysTip: '{delta} de DPS · {cost} de ouro para {target} ({chance})',
  forgeRowSelect: 'Planejar uma subida para {item}',
  forgeMoreRows: 'mais {count} — refine o filtro',
  forgeItemTitle: 'Peça',
  forgePickTitle: 'Escolha uma peça',
  forgePickDescription: 'Clique em uma linha para ver o que uma subida rende e quanto deve custar.',
  ...
  forgeFactBuysHero: 'O que rende para {hero}',
  forgeFactBuys: 'O que rende',
  ...
  forgeReasonNotYet: 'Forjar chega na próxima versão',
  forgeRailLastRun: 'Última execução: {item} {from} → {to} · {rolls} rolagens, {fails} falhas · {spent} de ouro · {age}',
  forgeRailTotals: '{runs} execuções · {spent} de ouro gastos',
