...
export const ptBR: Copy = {
  ...
  forgeRefreshRecent: 'Acabou de ler agora há pouco — a mochila já está no ponto',
  forgeRefreshFixture: 'Sem servidor para ler',
  forgeRefreshNotConsented: 'Aceite a leitura da conta em Configurações para atualizar a mochila',
  forgeRefreshGameNotRunning: 'Abra o jogo para ler a conta de novo',
