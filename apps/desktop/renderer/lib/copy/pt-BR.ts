...
export const ptBR: Copy = {
  ...
  accountHoldingsBag: 'Bolsa',
  accountHoldingsBagCoverage: '{priced} de {eligible} itens negociáveis com preço',
  accountHoldingsBagWithheld: 'Sua bolsa ainda não foi lida',
  accountHoldingsBagLink: 'Abrir a bolsa',
