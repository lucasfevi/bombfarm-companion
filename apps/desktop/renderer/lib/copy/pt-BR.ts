...
export const ptBR: Copy = {
  ...
  applyStepPointsFacts: '{heroes} — {respecs} com reset · {calls} chamadas · cerca de {time} · {gold} exato',
  applyStepNothing: 'Nada a fazer',
  applyStepDone: 'Concluído — {made} de {total} chamadas feitas, {skipped} puladas',
  applyStepDoneForge: 'Concluído — {count} mandados para a fila',
  applyStepForgeAllQueued: 'Todas as peças deste plano já estão na fila',
  ...
  applyPanelBlockedBody:
    'Algo mudou na sua conta desde que ele foi montado. O painel acima lista o que o quebrou; monte o plano de novo para continuar.',
  ...
  applyConfirmPointsBody: 'Um reset é cobrado por inteiro mesmo quando poucos pontos mudam.',
  applyConfirmPointsRespec: 'resetar',
  applyConfirmPointsPlace: 'colocar {points} pontos livres',
  applyConfirmPointsNoRespec: 'Sem reset',
  ...
  applyModalCallRespec: '{hero} — reset, depois {points} pontos',
  ...
  applyModalNowRespec: 'Resetando os pontos de {hero}',
  ...
  applySkipResetNotPlaced: 'reset feito, pontos não colocados — rode a etapa de novo',
