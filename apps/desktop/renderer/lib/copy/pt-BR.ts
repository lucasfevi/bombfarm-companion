...
export const ptBR: Copy = {
  ...
  liveEarningsGoldRecentLabel: 'ouro · últimos {minutes} min',
  liveEarningsGoldSessionLabel: 'ouro · sessão',
  liveEarningsXpRecentLabel: 'xp · últimos {minutes} min',
  liveEarningsXpSessionLabel: 'xp · sessão',
