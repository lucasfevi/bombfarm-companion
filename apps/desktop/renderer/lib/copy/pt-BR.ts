...
export const ptBR: Copy = {
  ...
  applyPanelIntro: 'O que cada etapa vai fazer, antes de você apertar qualquer coisa.',
  applyLedgerTotal: 'Total',
  applyLedgerReset: 'Redistribuir pontos',
  applyLedgerForge: 'Forja — pode passar do esperado',
  applyLedgerForgeNone: 'Forja — sem estimativa',
  applyLedgerEquip: 'Equipar — sem custo',
  applyLedgerWallet: '{before} → {after}',
  applyStepEquipTitle: 'Equipar',
  applyStepEquipFacts: '{calls} chamadas · cerca de {time} · sem custo',
  applyStepForgeTitle: 'Forja',
  ...
  applyStepPointsFacts: '{heroes} heróis ({respecs} com reembolso) · {calls} chamadas · cerca de {time} · {gold}',
