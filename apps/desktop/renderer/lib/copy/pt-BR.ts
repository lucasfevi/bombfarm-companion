...
export const ptBR: Copy = {
  ...
  applyStepEquipFacts:
    '{calls} em {heroes} heróis — {puton} colocados (uma peça já vestida sai na mesma chamada), {tobag} de volta à mochila · cerca de {time} · {gold}',
  ...
  applyPanelStale: 'A conta mudou desde este plano — monte-o de novo para aplicá-lo',
  applyPanelOtherRunning: '{step} está em execução — as outras etapas esperam',
  applyConfirmEquipTitle: 'Equipar itens?',
  applyConfirmEquipBody: 'Isto equipa e desequipa os itens que seu plano espera, sem custo de ouro.',
  applyConfirmEquip: 'Equipar {count} itens — sem custo',
  ...
  applyModalCallEquipFromBag: 'bolsa → {item} → {to}',
  applyModalCallUnequip: '{item} → bolsa',
  ...
  applyModalNowEquip: 'Colocando {item} em {hero}',
  applyModalNowUnequip: 'Devolvendo {item} à mochila',
