...
export const ptBR: Copy = {
  ...
  applyConfirmPointsHeroRespec: '{hero} · nível {level} · reembolso, depois coloca {points} pontos · {gold}',
  applyConfirmPointsHeroPlace: '{hero} · nível {level} · coloca {points} pontos livres · grátis',
  applyConfirmPointsHeroSkip: '{hero} · pulado — {reason}',
