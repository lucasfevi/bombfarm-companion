...
export const ptBR: Copy = {
  ...
  heroesEffectiveTip: 'Inclui equipamento, pontos, árvore, habilidades e as auras de time ligadas acima. Passagem de Bastão não entra aqui; as telas Farm e Otimizador contam o pulso de entrada dela.',
