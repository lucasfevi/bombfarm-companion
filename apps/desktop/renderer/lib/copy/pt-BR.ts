...
export const ptBR: Copy = {
  ...
  // settingsForge* — o único interruptor que deixa a aba Forja, a fila de forja e as etapas de
  // Aplicar do Otimizador gastarem ouro e moverem itens (desligado por padrão)
  ...
  // apply* — o painel Aplicar do Otimizador: o balanço, as três linhas numeradas, suas
  // confirmações e a janela bloqueante que mostra cada chamada saindo. Todo valor em ouro passa
  // pelo componente de moeda do app, nunca por um texto do pacote — aqui só as palavras.
  applyPanelTitle: 'Aplicar este plano',
  applyPanelIntro: 'Uma pressão por etapa. Cada chamada termina no servidor antes da próxima; pare quando quiser.',
  applyPanelStateNone: 'Nada aplicado ainda',
  applyPanelStateSome: '{done} de {total} feitas',
  applyPanelStateAll: 'Tudo feito',
  applyLedgerTotal: 'Ouro que este plano gasta',
  applyLedgerReset: 'Redistribuir pontos',
  applyLedgerExact: 'exato',
  applyLedgerForge: 'Forja',
  applyLedgerForgeExpected: 'esperado · pode passar',
  applyLedgerForgeNone: 'sem estimativa',
  applyLedgerFree: 'grátis',
  applyLedgerWalletLabel: 'Você tem',
  applyLedgerWallet: '→ {after} depois',
  applyStepEquipTitle: 'Equipar itens',
  applyStepCalls: '{n} chamadas',
  applyStepHeroes: '{n} heróis',
  applyStepEquipFacts:
  ...
  applyStepPointsTitle: 'Redistribuir pontos',
  applyStepPointsFacts: '{heroes} — {respecs} com reembolso · {calls} chamadas · cerca de {time} · {gold} exato',
  applyStepNothing: 'Nada a fazer',
  applyStepDone: 'Concluído — {made} de {total} chamadas feitas, {skipped} puladas',
  applyStepDoneForge: 'Concluído — {count} na fila',
  applyStepDoneLabel: 'Concluído',
  applyStepShowSkips: 'Mostrar o que foi pulado',
  applyStepHideSkips: 'Esconder o que foi pulado',
  applyStepStopped: 'Parou — {reason}',
  applyStepRunAgain: 'Tentar de novo',
  applyStepRunning: 'Em execução…',
  applyStepPausesQueue: 'Pausa a fila de forja enquanto roda',
  applyStepWillSkip: '{count} de {total} serão pulados — {reasons}',
  applySkipCounted: '{n} {reason}',
  applyStepNothingLeft: 'Nada mais para aplicar — monte o plano de novo',
  applyStepWalletShort: '{hero} será pulado — {needed} de ouro necessário, {onhand} em mãos',
  applyPanelSwitchOff: 'Ligue "{switch}" nas Configurações para aplicar por aqui',
  applyPanelBlockedTitle: 'Este plano não pode mais ser aplicado',
  applyPanelBlockedBody:
    'Algo mudou na sua conta desde que ele foi montado. Abra “Desde que este plano foi calculado”, acima, para ver o que mudou, e monte o plano de novo.',
  applyPanelOtherRunning: '{step} está em execução — as outras etapas esperam',
  applyConfirmEquipTitle: 'Equipar itens?',
  applyConfirmEquipBody: 'Isto equipa e desequipa os itens que o seu plano espera.',
  applyConfirmEquip: 'Equipar {count} itens',
  applyConfirmForgeTitle: 'Adicionar à fila de forja?',
  applyConfirmForgeBody: 'Nada roda até você iniciar a fila pelo próprio Iniciar.',
  applyConfirmForge: 'Adicionar {count} à fila',
  applyConfirmPointsTitle: 'Redistribuir pontos?',
  applyConfirmPointsBody: 'Um reembolso é cobrado por inteiro mesmo quando poucos pontos mudam.',
  applyConfirmPointsRespec: 'reembolso',
  applyConfirmPointsPlace: 'colocar {points} pontos livres',
  applyConfirmPointsNoRespec: 'Sem reembolso',
  applyConfirmPointsSkipped: 'pulado — {reason}',
  applyConfirmPointsSelectAria: 'Redistribuir os pontos de {hero}',
  applyConfirmPoints: 'Redistribuir pontos — gasta {gold}',
  ...
  applyModalWaitingForge: 'Esperando a peça de forja em andamento…',
  applyModalCallEquip: '{from} → {item} → {to}',
  applyModalCallEquipFromBag: 'Inventário → {item} → {to}',
  applyModalCallUnequip: '{item} → Inventário',
  applyModalInventory: 'Inventário',
  applyModalFrom: 'de {from}',
  applyModalCallRespec: '{hero} — reembolso, depois {points} pontos',
  applyModalCallCommit: '{hero} — coloca {points} pontos',
  applyModalCooldown:
    'O servidor do jogo pediu para irmos mais devagar — retomando em {countdown}. A chamada em curso não foi enviada; nada ficou pela metade.',
  applyModalNowEquip: 'Equipando {item} em {hero}',
  applyModalNowUnequip: 'Devolvendo {item} ao Inventário',
  applyModalNowRespec: 'Reembolsando os pontos de {hero}',
  applyModalNowCommit: 'Colocando os pontos de {hero}',
  applyModalNowBetween: 'Entre chamadas',
  applyModalLineRespec: 'reembolso, depois {points} pontos',
  applyModalLineCommit: 'coloca {points} pontos',
  applyModalFooter: '{done} feitas · {skipped} puladas · {left} restantes',
  applyModalGoldSoFar: '{gold} gastos até agora',
  applyModalQueuePaused: 'Fila de forja pausada',
  applyModalStop: 'Parar depois desta chamada',
  applyModalStopping: 'Parando depois desta chamada…',
  applyModalDoneEquipTitle: 'Itens equipados',
  applyModalDonePointsTitle: 'Pontos redistribuídos',
  applyModalStoppedTitle: 'Parado',
  applyModalDoneSummary: '{made} de {total} chamadas feitas · {skipped} puladas',
  applyModalGoldSpent: '{gold} gastos',
  applyModalDoneNext: 'A próxima etapa está pronta no painel.',
  applyModalDoneAll: 'Todas as etapas deste plano foram aplicadas.',
  applyModalSkippedTitle: 'Puladas',
  applyModalClose: 'Fechar',
  applyModalContinue: 'Continuar para a próxima etapa',
  applyModalProgressAria: 'Progresso da aplicação',
  applyModalLedgerAria: 'Chamadas feitas nesta execução',
  applySkipHeroLevel: 'o herói ainda não pode usar isto',
  applySkipItemMissing: 'o item saiu da bolsa desde o plano',
  applySkipItemMoved: 'o item não está onde o plano deixou',
  applySkipHeroMissing: 'o herói não está mais no elenco',
  applySkipAllocationChanged: 'os pontos do herói mudaram desde o plano',
  applySkipNotEnoughGold: 'ouro insuficiente',
  applySkipResetNotPlaced: 'reembolso feito, pontos não colocados — rode a etapa de novo',
  applySkipAlreadyDone: 'já estava feito quando a etapa chegou nele',
  applySkipForgeAtTarget: 'já está no alvo',
  applyStopStopped: 'você pediu para parar',
  applyStopUnauthorized: 'a sessão do jogo terminou…',
  applyStopNetwork: 'sem resposta do servidor',
