...
export const ptBR: Copy = {
  ...
  heroesEffectiveTip: 'Inclui equipamento, pontos, árvore, habilidades e as auras de time ligadas acima. Passagem de Bastão conta o pulso do próprio herói no tempo em campo dele; os pulsos dos outros portadores entram nas telas Farm e Otimizador. Matilha conta os heróis em campo ao lado deste.',
