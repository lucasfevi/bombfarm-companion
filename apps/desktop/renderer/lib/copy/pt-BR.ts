...
export const ptBR: Copy = {
  ...
  feedsNeverRead: 'Ainda não lido nesta sessão',
  feedsReadingNow: 'Lendo agora…',
  feedsOutOfDate: 'Desatualizado — esta tela foi calculada com uma cópia mais antiga da conta',
  feedsEvery: 'Atualiza sozinho a cada {cycle} · próxima em {age}',
  feedsEveryDue: 'Atualiza sozinho a cada {cycle} · pendente agora',
  feedsEveryUnread: 'Atualiza sozinho a cada {cycle}',
  feedsNoClock: 'Sem relógio próprio — lido quando a aba abre, e a cada duelo',
