...
export const ptBR: Copy = {
  ...
  applyModalProgress: 'chamada {n} de {total} · {elapsed} decorrido · cerca de {left} restante',
  ...
  applyModalCooldown:
    'O servidor do jogo pediu para desacelerarmos — retomando em {countdown}. A chamada {n} não foi enviada; nada ficou pela metade.',
