...
export const ptBR: Copy = {
  ...
  forgeWornLabel: 'Filtrar por quem está usando',
  forgeWornAny: 'Usado ou não',
  forgeWornEquipped: 'Usado por um herói',
  forgeWornSpare: 'Ninguém usando',
  forgeWornImplied: 'Um herói foi escolhido, então toda peça aqui é uma que ele usa',
  ...
  forgeLedgerSummary: '{runs} execuções · {spent} de ouro',
  ...
  forgeLedgerTotals: '{runs} execuções · {spent} de ouro · {rolls} rolagens · {fails} falhas',
