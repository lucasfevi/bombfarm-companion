...
export const ptBR: Copy = {
  ...
  heroesEffectiveTip: 'Inclui equipamento, pontos, árvore, habilidades e as auras de time ligadas acima.',
  ...
  optimizerAuraDisclosureDps: 'Auras de time aqui vêm do roster no escopo, excluem o herói pontuado e são ponderadas pelo duty de cada portador. As telas Farm e Heróis precificam as auras pelo roster em campo, então o DPS delas pode divergir desta tela.',
  optimizerAuraDisclosureFarm: 'Auras de time aqui vêm do roster no escopo, excluem o herói pontuado e são ponderadas pelo duty de cada portador. As telas Farm e Heróis precificam as auras pelo roster em campo, então os números de ouro delas podem divergir desta tela.',
  optimizerDivergenceDps: 'O DPS da tela Heróis pode divergir desta tela quando as auras são precificadas pelo roster em campo em vez do roster no escopo, ou quando {ability} é modelada só aqui.',
  optimizerDivergenceFarm: 'Os números da tela Farm podem divergir desta tela quando as auras são precificadas pelo roster em campo em vez do roster no escopo, ou quando {ability} é modelada só aqui.',
