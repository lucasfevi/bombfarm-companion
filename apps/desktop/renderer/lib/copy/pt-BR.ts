...
export const ptBR: Copy = {
  ...
  heroesBoardSortLabel: 'Ordenar por',
  heroesBoardSortRoll: 'Sorteio',
  heroesBoardSortPower: 'Poder',
  heroesBoardSortLevel: 'Nível',
  heroesBoardSortRarity: 'Raridade',
  heroesBoardSortRank: 'Nota',
