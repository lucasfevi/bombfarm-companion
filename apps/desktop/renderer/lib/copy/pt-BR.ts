...
export const ptBR: Copy = {
  ...
  feedsEvery: 'atualiza sozinho a cada {cycle}',
  feedsNoClock: 'sem relógio próprio — lido quando a aba abre, e a cada duelo',
  feedsNextIn: 'próxima atualização automática em {age}',
  feedsNextDue: 'atualização automática pendente',
  feedsNotYet: 'ainda não',
  feedsReading: 'lendo…',
