...
export const ptBR: Copy = {
  ...
  forgeRailClear: 'Limpar o registro',
  forgeRailClearTitle: 'Limpar o registro da forja?',
  forgeRailClearDescription: 'Todas as execuções passadas e os totais vão junto. O ouro foi gasto de qualquer forma.',
  forgeRailClearConfirm: 'Limpar',
  forgeRailClearCancel: 'Manter',
  forgeRailRolls: '{rolls} rolagens',
  forgeRailSpent: '{spent} de ouro',
  forgeRailWallet: 'carteira {wallet}',
  forgeRailRecent: 'Recentes',
  ...
  forgeResultWalletAfter: 'Carteira depois',
  forgeResultDuration: 'Duração',
  forgeAgainstPlanTitle: 'Contra o plano',
  forgeAgainstSpent: 'gasto {gold}',
  forgeAgainstExpected: 'esperado {gold}',
  forgeAgainstBadRun: 'uma má sequência {gold}',
  forgeAgainstNoPlan: 'Sem plano para comparar — esta execução não partiu do painel',
  forgeBoughtTitle: 'Comprou',
  forgeBoughtRealised: '{delta} de DPS para {hero}, contra os {promised} que o plano prometia',
  forgeBoughtNobody: 'Ninguém usa esta peça, então nada muda no campo por enquanto',
  forgeBoughtNext: '{level} mantém os atributos; a próxima rolagem para {next} é {chance}',
  forgeBoughtWiped: '{loss} de DPS até reconstruir',
  forgeBoughtTop: '{level} é o topo da escada',
  forgeDone: 'Concluir',
