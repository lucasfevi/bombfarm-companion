...
describe('navItemsFor', () => {
  it('offers exactly Live, Farm, Heroes, Inventory, Forge, Optimizer, Account, Settings, in that order, in every flavor', () => {
  ...
  it('puts Heroes after Farm, Forge after Inventory, Optimizer after Forge and Account after Optimizer, and leaves Settings last', () => {
    ...
    expect(ids.indexOf('account')).toBe(ids.indexOf('optimizer') + 1);
