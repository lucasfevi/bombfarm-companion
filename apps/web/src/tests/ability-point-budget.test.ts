...
describe('abilityPointBudget (BSPW3-11, AD-BSP-23)', () => {
  ...
  // AC-23a — boundary cases, re-pointed onto the post-patch corpus (F1, ground-truth-rule class
  ...
  it('AC-23b: spent === min(level, quota x 20) holds 13/13 across both post-patch corpus files (equality, not <=)', () => {
    // F1 (ground-truth-rule class (a) — read from the capture): re-pointed onto both corpus files
