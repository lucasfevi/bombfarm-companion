...
export function skillTreeLabels(copy: Strings, lang: Lang, phaseSource: SkillsPhaseSource = 'farm'): SkillTreeLabels {
  ...
  return {
    ...
    before: copy.skillsBefore,
    after: copy.skillsAfter,
    change: copy.skillsChange,
    percentChange: (fraction) => signedPercent(fraction, lang),
    ...
    treeProgress: (ownedLevels, totalLevels) =>
      sub(copy.skillsTreeProgress, { owned: ownedLevels, total: totalLevels }),
