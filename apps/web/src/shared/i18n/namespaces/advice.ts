...
export const en = {
  ...
  effectiveTip: "Includes gear, points, skill tree, abilities, and the team auras switched on below. Pack counts the heroes deployed beside this one.",
  effectiveFuse: "Fuse",
  effectiveRest: "Rest",
...
export const pt: typeof en = {
  ...
  effectiveTip: "Inclui equipamento, pontos, árvore, habilidades e as auras de time ligadas abaixo. Matilha conta os heróis em campo ao lado deste.",
  effectiveFuse: "Pavio",
