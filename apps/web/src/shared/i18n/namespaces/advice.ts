  ...
  explainSections: [
    {
      ...
      p: [
        ...
        "Skill points add a fixed share per point: Attack gains +10 × level power (+4% per level from the wiki) or +8 energy per point, while Speed 2%, Penetration 2% and Luck 3% add a fixed share of the base roll per point. Crit chance, crit damage and CDR are the exceptions — they add flat percentage points (+0.024394, +5 and +0.03513 per point), the same for every hero regardless of its roll, and gear, sheet abilities and the skill tree add to them the same flat way. Crit chance caps at 100%; CDR caps at 80% (20% of cycle remains). The skill tree (total damage already includes squad + compound/multiplied damage; also crit chance, crit damage, speed, energy, Luck as a flat add) applies once, then abilities and team buffs multiply in. Account shares House, Skill tree and Team buffs across heroes; your farm phase (and its mitigation) sync from the Phases page via Use as farm phase. Panel Effective stats shows the resulting combat sheet plus Fuse and Rest.",
  ...
  explainSections: [
    {
      ...
      p: [
        ...
        "Os pontos somam uma fração fixa por ponto: Ataque ganha +10 × poder de nível (+4% por nível na wiki) ou +8 de energia por ponto; Velocidade 2%, Penetração 2% e Sorte 3% ganham uma fração fixa do roll base por ponto. Chance de crítico, dano crítico e redução de recarga são as exceções — somam pontos percentuais fixos (+0,024394, +5 e +0,03513 por ponto), iguais para todo herói independente do roll, e itens, habilidades de ficha e a árvore somam neles do mesmo jeito fixo. Chance de crítico tem teto de 100%; redução de recarga tem teto de 80% (20% do ciclo permanece). A árvore de habilidades (o dano total já inclui dano de esquadrão + dano composto/multiplicado; também chance de crítico, dano crítico, velocidade, energia, Sorte como soma fixa) aplica uma única vez, depois habilidades e buffs de time multiplicam o resultado. A Conta compartilha Casa, Árvore de habilidades e Buffs de time entre heróis; a fase de farm (e a mitigação) sincronizam pela página Fases com Usar como fase de farm. O painel Stats efetivos mostra a ficha de combate resultante, além de Pavio e Descanso.",
