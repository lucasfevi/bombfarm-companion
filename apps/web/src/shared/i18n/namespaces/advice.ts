  ...
  explainSections: [
    ...
    },
    {
      ...
      p: [
        ...
        "The search treats every pool item as forged up to at least your forge floor. Results are shown as three steps — today, gear, optional point resets — plus forge/move chore lists. The final result and the point-reset step never lose ground compared to today; the gear step can dip below today for a moment before the point resets catch it back up, and the page tells you plainly when that happens. A hero can still personally lose DPS when that trade grows the roster total. Each point reset shows its in-game gold cost next to the roster DPS it is worth, listed best value first — the app never blocks a reset for being expensive, it only shows the price. Copy always says the best roster DPS found by this search, never a claim of true optimality. Send to alt loadout writes proposed gear to each hero's clone row only after you confirm.",
      ],
  ...
  explainSections: [
    ...
    },
    {
      ...
      p: [
        ...
        "A busca trata cada item do pool como forjado pelo menos até o piso de forja. O resultado aparece em três passos — hoje, gear, resets de pontos opcionais — mais listas de forja e movimentos. O resultado final e o passo de reset de pontos nunca ficam abaixo de hoje; o passo de gear pode cair por um momento antes que os resets de pontos recuperem, e a página avisa claramente quando isso acontece. Um herói ainda pode perder DPS pessoalmente quando essa troca aumenta o total do roster. Cada reset de pontos mostra o custo em ouro no jogo ao lado do DPS de roster que ele vale, listados do melhor valor primeiro — o app nunca bloqueia um reset por ser caro, só mostra o preço. O texto sempre diz o melhor DPS de roster encontrado por essa busca, nunca uma garantia de ótimo verdadeiro. Enviar para alt loadout grava o gear proposto na linha clone de cada herói só depois da confirmação.",
      ],
