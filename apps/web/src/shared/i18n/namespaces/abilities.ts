export const en = {
  ...
  abilitiesTip: "This hero’s own skills. Keen Eye, Diamond Tip and Brutal Strike change crit chance, penetration and crit damage on the hero’s in-game stats. Forced March, Deadly Omen and other abilities only count during combat. Team auras are on the Combat tab, each with its own switch.",
