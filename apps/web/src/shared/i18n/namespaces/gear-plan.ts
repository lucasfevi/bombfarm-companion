export const en = {
  ...
  gearPlanOptimizingTitle: 'Searching…',
  gearPlanOptimizingBody: 'Looking for better gear across your roster.',
  gearPlanOptimizingElapsed: 'Elapsed {time}',
  gearPlanOptimizingCancel: 'Cancel',
  gearPlanOptimizingProgressAria: 'Search in progress',
  gearPlanSetupSectionTitle: 'Search setup',
  gearPlanRunSummaryTitle: 'Run summary',
  ...
  gearPlanHeroBreakdownGearTitle: 'Proposed gear',
  gearPlanHeroBreakdownGearEmpty: 'No gear changes recommended for this hero.',
  gearPlanHeroBreakdownPointsTitle: 'Point reset',
  gearPlanHeroBreakdownPointsEmpty: 'No point reset is recommended for this hero.',
  gearPlanCompactNumberHint: 'Numbers are abbreviated — hover over one to see the exact value.',
...
export const pt: typeof en = {
  ...
  gearPlanOptimizingTitle: 'Buscando…',
  gearPlanOptimizingBody: 'Procurando gear melhor no seu roster.',
  gearPlanOptimizingElapsed: 'Decorrido {time}',
  gearPlanOptimizingCancel: 'Cancelar',
  gearPlanOptimizingProgressAria: 'Busca em andamento',
  gearPlanSetupSectionTitle: 'Configurar busca',
  gearPlanRunSummaryTitle: 'Resumo da execução',
  gearPlanRunSummaryRegime: 'Regime',
  gearPlanRunSummaryDuty: 'Σ duty vs slots',
  gearPlanBudgetExhausted:
  ...
  gearPlanForgeFloorHint:
    'Itens abaixo deste nível entram na lista de forja. O plano trata todo item como pelo menos neste nível de forja.',
  ...
  gearPlanHeroBreakdownGearTitle: 'Gear proposto',
  gearPlanHeroBreakdownGearEmpty: 'Nenhuma troca de gear recomendada para este herói.',
  ...
  gearPlanCompactNumberHint: 'Os números estão abreviados — passe o mouse sobre um deles para ver o valor exato.',
