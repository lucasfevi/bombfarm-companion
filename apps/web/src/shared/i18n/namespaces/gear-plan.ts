export const en = {
  ...
  gearPlanHeroBreakdownGearEmpty: 'No item changes recommended for this hero.',
...
export const pt: typeof en = {
  ...
  gearPlanHeroBreakdownGearEmpty: 'Nenhuma troca de item recomendada para este herói.',
