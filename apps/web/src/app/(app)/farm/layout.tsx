...
/**
 * Server layout for `/farm` — static, untranslated `<title>` (`ASM-C9`). A static export
 ...
 * deliberately so it reads fine untranslated (`AD-PFR-17`); the in-page heading and nav
