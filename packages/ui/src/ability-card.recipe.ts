 ...
 * 0.55 measures 5.24:1 (computed via OKLCH -> linear-sRGB -> WCAG relative
 * luminance), comfortably clear of the threshold while still reading as
 * de-emphasized/locked.
 */
