...
const panelUnverifiedClass = 'opacity-[0.78]';
...
/** Keystone row control cluster (On/Off status + Switch) in stack column 2. */
export const accountKeystoneControlClass = 'flex items-center justify-end gap-2';

/** Compact On/Off status beside a Switch in keystone rows. */
export const accountKeystoneStatusClass =
  'min-w-[2.25rem] text-right text-[11px] font-semibold tracking-[0.02em] text-muted';
...
export const importAccountClass =
  'mb-3.5 border border-[color-mix(in_oklch,var(--accent)_28%,var(--line))] bg-[linear-gradient(135deg,color-mix(in_oklch,var(--accent)_9%,var(--surface)),color-mix(in_oklch,var(--bg)_40%,var(--surface)))] px-3.5 py-3 text-xs';
...
export const importWarningsClass = 'mt-2.5 text-xs text-muted [&_summary]:cursor-pointer';
