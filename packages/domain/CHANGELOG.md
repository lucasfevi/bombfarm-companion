...
- fdc8b8e: Stat-point advice for gold per hour is built from zero, not from the build you have.
...
- a8f352f: Carry the Passagem de Bastão pulse cooldown in the team-plan model, and prove it cannot bind.
...
- f534b9e: Refresh the committed phase/economy wiki bundle against the wiki as published on 2026-09-02.

  Every game value in the bundle is unchanged — the four sections that moved (combat coefficients,
  hero tables, market unlock, first-clear prizes) carry no field this bundle or the domain reads, and
  the ones it does read still match the wiki exactly. Only the bundle's provenance stamps advance.
