...
describe('account.max_phase — the fixture, both entry points', () => {
...
describe('account.max_phase — source precedence', () => {
...
describe('account.max_phase — normalization', () => {
...
describe('account.max_phase — rejection paths yield null', () => {
