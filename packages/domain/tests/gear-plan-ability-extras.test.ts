...
} from '@bombfarm/domain/gear-plan/ability-extras';
import type { HeroPlanContext } from '@bombfarm/domain/gear-plan/types';
...
describe('ASM-S03 boundary', () => {
  it('ABILITIES passagem_bastao stays kind none and helper implements formula', () => {
    // ASM-S03: planner catalog untouched; gear-plan scorer models the effect separately.
