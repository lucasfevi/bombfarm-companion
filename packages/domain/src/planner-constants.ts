 ...
 * and stored (AD-BSP-19) but excluded from combat scoring (BSP-42, AD-BSP-20). Wave 6
...
/**
 * Apply a partial point step to a single stat (`BSP-25`, full form — the user's Q-1 decision
