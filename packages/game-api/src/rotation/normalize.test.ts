...
describe('roster join', () => {
  it('all 8 fixture heroes resolve with a name, grade, rarity and stars from /roster', () => {
  ...
  it('a hero with no matching /roster entry resolves with an absent name/grade/rarity/stars, an unchanged id, and no drop event', () => {
