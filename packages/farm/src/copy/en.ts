...
export const farmEn = {
  ...
  phasesPenNeedHint: "Penetration pierces a share of this cut, not points off it — only 100% penetration ignores it all",
  ...
  phasesPenOk: "Nothing lost to mitigation",
  phasesPenShort: "{lost}% of each hit lost — {pen}% of the phase’s {mit}% pierced",
