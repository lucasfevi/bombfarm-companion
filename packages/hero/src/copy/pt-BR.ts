...
export const heroPtBR: HeroCopy = {
  ...
  heroDetailAuraUnitDrain: "−{value}% de gasto",
  heroDetailAuraUnitPenetration: "+{value} de penetração",
  heroDetailAuraUnitCritDmg: "+{value}% de dano crítico",
  heroDetailAuraUnitRange: "+{value} de alcance",
