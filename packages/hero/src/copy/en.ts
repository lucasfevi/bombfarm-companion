...
export const heroEn = {
  ...
  heroDetailAuraRank: "rank {rank}",
  heroDetailAuraUnitAttack: "+{value}% attack",
  heroDetailAuraUnitSpeed: "+{value}% speed",
  heroDetailAuraUnitCrit: "+{value} crit points",
  heroDetailAuraUnitDrain: "−{value}% drain",
  heroDetailAuraUnitPenetration: "+{value} penetration",
  heroDetailAuraUnitCritDmg: "+{value}% crit damage",
