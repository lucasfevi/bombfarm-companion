...
at out of twenty; and its gear, each piece with its item level and forge upgrade. The exact
reading behind every bar is on the bar's own tooltip, so the compact form loses nothing.
