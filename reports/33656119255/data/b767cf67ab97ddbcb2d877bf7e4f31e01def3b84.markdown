...
- Name: farm-respec.spec.ts >> Farm Respec Advisor >> Optimize is keyboard-activatable and exposes aria-expanded; the re-rank switch is keyboard-reachable with an accessible name
- Location: e2e/farm-respec.spec.ts:262:7
